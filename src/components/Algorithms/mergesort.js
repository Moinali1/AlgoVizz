...
async function mergePart(ele, low, mid, high,stopSort,delay){
...
async function merge(ele, l, r,stopSort,delay){
    ...
    await merge(ele, l, m,stopSort,delay);
    await merge(ele, m + 1, r,stopSort,delay);
    await mergePart(ele, l, m, r,stopSort,delay);
}
